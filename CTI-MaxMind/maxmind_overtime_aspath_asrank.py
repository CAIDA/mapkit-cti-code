...
country_filename = "/project/mapkit/agamerog/country_asn_analysis/country_aspath/sorted_summaries/" + current_snapshot + "/" + current_country + ".maxmind.csv"

#asrel_filename = '/data/external/as-rank-ribs/' + current_snapshot + '/' + current_snapshot + '.as-rel.txt.bz2'

asrel_filename = '/data/external/as-rank-ribs/' + current_snapshot + "/" + current_snapshot + '.as-rel.txt.bz2'

country_output = "/project/mapkit/agamerog/country_asn_analysis/country_aspath/" + current_snapshot + "/top." + current_country + ".maxmind.csv"

country_matrix = "/project/mapkit/agamerog/country_asn_analysis/country_aspath/" + current_snapshot + "/" + current_country + ".maxmind.csv"

country_origin = "/project/mapkit/agamerog/country_asn_analysis/country_aspath/origin/" + current_snapshot + "/" + current_country + ".csv"

country_cti = "/project/mapkit/agamerog/country_asn_analysis/country_aspath/" + current_snapshot + "/" + current_country + ".maxmind.cti.csv"

country_ext = "/project/mapkit/agamerog/country_asn_analysis/country_aspath/" + current_snapshot + "/ext." + current_country + ".csv"

country_top_cti = """/project/mapkit/agamerog/country_asn_analysis/country_aspath/sorted_summaries/""" + current_snapshot + """/top.""" + current_country + """.maxmind.cti.csv"""
...
def sort_country_output():
    command = """cat /project/mapkit/agamerog/country_asn_analysis/country_aspath/""" + current_snapshot + """/<CC>.maxmind.cti.csv | grep -v e-0 |awk -F, '{print $2,$0}' | sort -nr | cut -f2- -d' ' | awk -F, '{print $1","$2}' > /project/mapkit/agamerog/country_asn_analysis/country_aspath/sorted_summaries/""" + current_snapshot + """/top.<CC>.maxmind.cti.csv; cat /project/mapkit/agamerog/country_asn_analysis/country_aspath/""" + current_snapshot + """/<CC>.maxmind.cti.csv | grep e-0 | awk -F, '{print $2,$0}' | sort -nr | cut -f2- -d' ' | awk -F, '{print $1","$2}'>> /project/mapkit/agamerog/country_asn_analysis/country_aspath/sorted_summaries/""" + current_snapshot + """/top.<CC>.maxmind.cti.csv"""
