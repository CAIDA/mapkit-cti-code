...
ratio_file = "/project/mapkit/agamerog/country_asn_analysis/logs/ratio/" + current_country + ".maxmind.txt"
...
aspath_filename = "/project/mapkit/agamerog/country_asn_analysis/singlecountryfiles/maxmind." + current_country + "." + current_snapshot + ".txt.bz2" #AGG SINGLE COUNTRY TODO MAY NEED TO CHANGE BACK
...
country_filename = "/project/mapkit/agamerog/country_asn_analysis/country_aspath/" + current_snapshot + "/" + current_country + ".maxmind.cti.csv"
...
def write_country_output(as_dict, pfix_dict, origin_ases, \
   ...
   #compute final TI values per origin/transit AS pair
    ...
    #pos_file = country_filename.replace('.maxmind.csv','.pos.csv')
