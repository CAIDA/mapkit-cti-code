...
def main():
    ...
    for i in range(len(countries)):
        ...
        for i in range(10):
            ...
            if country_ases[curr_rank] == second_country_ases[curr_rank]:
                ...
                if country_ases[curr_rank] in reverse_second_country_ases:
                    ...
                    if curr_change > 10:
                        print "***********"
                        print second_country_ases[curr_rank]
                        print reverse_country_ases[second_country_ases[curr_rank]]
                        print reverse_second_country_ases[second_country_ases[curr_rank]]
        ...
        print country + ',' + str(remained_count) + "," + str(intersection_number) + "," + str(round(np.mean(rank_change_list),2)) + "," + str(unranked_first) + "," + str(unranked_second)
